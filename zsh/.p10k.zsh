# Generated by Powerlevel10k configuration wizard on 2023-07-06 at 14:44 CST.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 6405.
# Wizard options: nerdfont-v3 + powerline, large icons, unicode, lean_8colors, 24h time,
# 2 lines, dotted, no frame, blue-ornaments, sparse, many icons, concise,
